INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (0, 1, 0, null, 0, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (1, 1, 3, 0, null, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (2, 1, 3, 1, null, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (3, 1, 3, 2, null, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (4, 1, 3, 3, null, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (5, 1, 3, 4, null, 0);

INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (6, 1, 4, 8, null, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, status) VALUES (7, 1, 4, 9, null, 0);
