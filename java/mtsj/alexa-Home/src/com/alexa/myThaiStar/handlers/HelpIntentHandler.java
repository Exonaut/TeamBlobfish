...
public class HelpIntentHandler implements RequestHandler {
  ...
  public Optional<Response> handle(HandlerInput input) {
    ...
    String speechText = "Wenn Sie einen Tisch buchen möchten, dann sagen Sie zum Beispiel: Ich möchte einen Tisch buchen."
        + "Wenn Sie wissen möchten was auf der Karte steht, dann sagen Sie zum Beispiel: Die Karte bitte."
